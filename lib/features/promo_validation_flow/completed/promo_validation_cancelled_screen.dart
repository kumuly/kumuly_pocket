...
class PromoValidationCancelledScreen extends ConsumerWidget {
  const PromoValidationCancelledScreen({super.key});
          ...
          children: [
              ...
              children: [
                ClipOval(
                  child: Image.asset(
                    ...
                    color: Palette.error[40]?.withOpacity(0.7),
                  ),
                ),
                  ...
                  children: [
                    Text(
                      ...
                      style: textTheme.display5(
                          Palette.error[40], FontWeight.w600),
            ...
            Column(
              ...
              children: [
                ...
                Text(
                  copy.theCustomerCanClaimARefund,
