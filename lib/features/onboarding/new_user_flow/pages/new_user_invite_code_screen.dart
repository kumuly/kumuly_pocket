...
class NewUserInviteCodeScreen extends ConsumerWidget {
  const NewUserInviteCodeScreen({super.key});
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  children: List.generate(state.inviteCodeLength, (index) {
                    if (index == 4) {
                      return Text(
                        '-',
          ...
          Row(
            ...
            children: [
              PrimaryFilledButton(
                ...
                onPressed:
                    state.inviteCode.isEmpty ? null : pageController.nextPage,
              ),
            ],
          ),
          const SizedBox(height: kSpacing3),
