...
class WalletRecoveryInputScreen extends ConsumerWidget {
  const WalletRecoveryInputScreen({super.key});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final state = ref.watch(walletRecoveryControllerProvider);
    final notifier = ref.read(walletRecoveryControllerProvider.notifier);
    final pageViewController = ref.read(
      pageViewControllerProvider(kWalletRecoveryFlowPageViewId).notifier,
    );
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: TextFormField(
                              autofocus:
                                  index == 0 && state.words[index].isEmpty,
